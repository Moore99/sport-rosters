...
```bash
flutter build appbundle --release --dart-define=GOOGLE_PLACES_API_KEY=***REMOVED_GOOGLE_PLACES_API_KEY***
```
...
### Android Testing
1. `flutter build apk --release --dart-define=GOOGLE_PLACES_API_KEY=***REMOVED_GOOGLE_PLACES_API_KEY***`
...
|----------|---------|-------|--------|
| Android (Play Store) | 1.0.3 | 7 | Internal testing (ready to promote) |
| iOS (App Store) | 1.0.3 | 21 | Submitted for production |
