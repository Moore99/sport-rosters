...
const USERS = [
  ...
  {
    name: "Alice Coach",
    email: "alice.coach@test.com",
    role: "player",
    weightKg: 68,
  },
  {
    name: "Brian Coach",
    email: "brian.coach@test.com",
    role: "player",
    weightKg: 80,
  },
  // Players
  {
    name: "Carol Adams",
    email: "carol.adams@test.com",
    role: "player",
    weightKg: 61,
  },
  {
    name: "Dave Baker",
    email: "dave.baker@test.com",
    role: "player",
    weightKg: 90,
  },
  {
    name: "Eve Carter",
    email: "eve.carter@test.com",
    role: "player",
    weightKg: 57,
  },
  {
    name: "Frank Davis",
    email: "frank.davis@test.com",
    role: "player",
    weightKg: 78,
  },
  {
    name: "Grace Evans",
    email: "grace.evans@test.com",
    role: "player",
    weightKg: 65,
  },
  {
    name: "Henry Ford",
    email: "henry.ford@test.com",
    role: "player",
    weightKg: 85,
  },
  {
    name: "Iris Green",
    email: "iris.green@test.com",
    role: "player",
    weightKg: 59,
  },
  {
    name: "Jack Hill",
    email: "jack.hill@test.com",
    role: "player",
    weightKg: 76,
  },
  {
    name: "Karen Irving",
    email: "karen.irving@test.com",
    role: "player",
    weightKg: 63,
  },
  {
    name: "Liam Jones",
    email: "liam.jones@test.com",
    role: "player",
    weightKg: 83,
  },
  {
    name: "Maya King",
    email: "maya.king@test.com",
    role: "player",
    weightKg: 55,
  },
  {
  ...
  {
    name: "Paul Nelson",
    email: "paul.nelson@test.com",
    role: "player",
    weightKg: 92,
  },
  {
    name: "Quinn Owens",
    email: "quinn.owens@test.com",
    role: "player",
    weightKg: 70,
  },
  {
    name: "Rachel Park",
    email: "rachel.park@test.com",
    role: "player",
    weightKg: 58,
  },
  {
    name: "Sam Quinn",
    email: "sam.quinn@test.com",
    role: "player",
    weightKg: 75,
  },
  {
    name: "Tina Reed",
    email: "tina.reed@test.com",
    role: "player",
    weightKg: 62,
  },
  {
  ...
  {
    name: "Victor Tang",
    email: "victor.tang@test.com",
    role: "player",
    weightKg: 86,
  },
  {
    name: "Wendy Upton",
    email: "wendy.upton@test.com",
    role: "player",
    weightKg: 67,
  },
  {
    name: "Xander Vance",
    email: "xander.vance@test.com",
    role: "player",
    weightKg: 79,
  },
  {
    name: "Yara Walsh",
    email: "yara.walsh@test.com",
    role: "player",
    weightKg: 56,
  },
  {
    name: "Zach Xavier",
    email: "zach.xavier@test.com",
    role: "player",
    weightKg: 81,
  },
  {
    name: "Amy Young",
    email: "amy.young@test.com",
    role: "player",
    weightKg: 64,
  },
  {
    name: "Ben Zhang",
    email: "ben.zhang@test.com",
    role: "player",
    weightKg: 74,
  },
  {
    name: "Clara Abbott",
    email: "clara.abbott@test.com",
    role: "player",
    weightKg: 66,
  },
  {
    name: "Dylan Brooks",
    email: "dylan.brooks@test.com",
    role: "player",
    weightKg: 87,
  },
];
...
async function main() {
  ...
  for (const team of TEAMS) {
    const adminUids = team.adminIndices
      .map((i) => createdUids[i]?.uid)
      .filter(Boolean);
    const playerUids = team.playerIndices
      .map((i) => createdUids[i]?.uid)
      .filter(Boolean);
    ...
    const adminNames = team.adminIndices
      .map((i) => createdUids[i]?.name)
      .join(", ");
