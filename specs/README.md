...
One file per domain. Each spec covers: what it does, user-facing behaviour, data model, Firestore rules, Cloud Functions, key decisions (the _why_), and future/deferred items.
