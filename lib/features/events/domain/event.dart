...
class Event {
  ...
  factory Event.fromFirestore(DocumentSnapshot doc) {
    ...
    return Event(
      ...
      boatConfig: d['boatConfig'] != null
          ? BoatConfig.fromMap(
              Map<String, dynamic>.from(d['boatConfig'] as Map))
          : null,
      ...
      gameResult: d['gameResult'] != null
          ? GameResult.fromMap(
              Map<String, dynamic>.from(d['gameResult'] as Map))
          : null,
  ...
  static EventType _typeFrom(String s) => EventType.values
      .firstWhere((e) => e.name == s, orElse: () => EventType.practice);
}
