...
class _CreateEventScreenState extends ConsumerState<CreateEventScreen> {
  ...
  Future<void> _submit() async {
    ...
    final sport =
        ref.read(teamProvider(widget.teamId)).valueOrNull?.sport ?? '';
    ...
    try {
      if (_recurrence == _Recurrence.none) {
        ...
        await ref
            ...
            .createEvent(makeEvent(docRef.id, _eventDateTime));
      } else {
                    ...
                    children: [
                      ...
                      if (sport == 'Dragon Boating') ...[
                        ...
                        SwitchListTile(
                          ...
                          subtitle: const Text(
                              'Each boat has a drummer at the front.'),
                          value: _hasDrummer,
                      ...
                      if (widget.copyFrom == null) ...[
                        ...
                        SegmentedButton<_Recurrence>(
                          segments: const [
                            ButtonSegment(
                                value: _Recurrence.none, label: Text('None')),
                            ButtonSegment(
                                value: _Recurrence.weekly,
                                label: Text('Weekly')),
                            ButtonSegment(
                                value: _Recurrence.biweekly,
                                label: Text('Biweekly')),
                          ],
                        ...
                        if (_recurrence != _Recurrence.none) ...[
                          ...
                          ListTile(
                            ...
                            onTap: () async {
                              final interval =
                                  _recurrence == _Recurrence.weekly ? 7 : 14;
                              final picked = await showDatePicker(
                                context: context,
                                initialDate:
                                    _date.add(Duration(days: interval)),
