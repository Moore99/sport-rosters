      ...
      body: SafeArea(
          ...
          child: eventsAsync.when(
            ...
            data: (events) {
              ...
              if (events.isEmpty)
                return _EmptyState(isAdmin: isAdmin, teamId: teamId);
...
class _EventList extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (_, i) =>
          _EventCard(event: events[i], teamId: teamId, uid: uid),
    );
  }
}
...
class _EventCard extends ConsumerWidget {
  ...
  const _EventCard(
      {required this.event, required this.teamId, required this.uid});
            ...
            children: [
              ...
              Expanded(
                child: ListTile(
                  ...
                  onTap: () =>
                      context.push('/teams/$teamId/events/${event.eventId}'),
                ),
              ),
            ],
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            if (isAdmin) ...[
              ...
              const Text(
                  'Tap + Add Event to schedule your first game or practice.',
