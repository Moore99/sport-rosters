enum AdminParticipation {
  ...
  String get label {
    switch (this) {
      case AdminParticipation.player:
        return 'I play on the team';
      case AdminParticipation.coachOnly:
        return 'I coach only (not in lineup)';
      case AdminParticipation.sometimes:
        return 'Sometimes play, sometimes coach';
    }
  }
