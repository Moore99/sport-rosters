...
final myPreferenceProvider =
    StreamProvider.family<PlayerPreference?, ({String teamId, String userId})>(
        (ref, args) {
  return ref
...
final teamPreferencesMapProvider =
    StreamProvider.family<Map<String, PlayerPreference>, String>((ref, teamId) {
  return ref
      .read(playerPreferenceRepositoryProvider)
