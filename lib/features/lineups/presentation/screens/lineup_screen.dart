...
class _LineupScreenState extends ConsumerState<LineupScreen> {
  ...
  Future<void> _autoGenerate(
    ...
    final positions     = ref.read(positionsForSportProvider(team.sport));
    final sportCats     = ref.read(categoriesForSportProvider(team.sport));
  ...
  Widget build(BuildContext context) {
    ...
    return teamAsync.when(
      ...
      data: (team) {
        ...
        final positions = ref.watch(positionsForSportProvider(team.sport));
